...
<Aside type="tip">
This definition maps to the [`RuleType`](/integrations/utilities#ruletype) type. Use [`serializeFeature`](/integrations/utilities#serialization) to parse and serialize feature files.
</Aside>
